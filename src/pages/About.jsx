...
function About() {
    return (
        <>
            ...
            <Employee
                name="Travis Dunlap"
                description="Travis Dunlap is a dedicated Warehouse Manager who ensures daily operations run efficiently and smoothly. With years of experience in logistics, he excels at optimizing storage, coordinating shipments, and managing a hardworking team. Known for his hands-on leadership style, Travis isn’t afraid to jump in and help when things get hectic. His attention to detail and problem-solving skills keep the warehouse organized and running like a well-oiled machine.Travis Dunlap has spent over a decade mastering warehouse logistics, making him a trusted leader in operations management. He takes pride in mentoring his team, ensuring every employee is trained to handle the fast-paced demands of the warehouse. Always looking for ways to improve efficiency, Travis implements new strategies to streamline workflows and reduce downtime. His ability to stay calm under pressure and make quick decisions keeps the warehouse running at peak performance."
                imageUrl="images/employee3.jpg"
            />

            <Employee
                name="Jake Thornton"
                description="Jake Thornton is the hardworking Assistant Warehouse Manager who keeps operations running seamlessly alongside the management team. He specializes in employee coordination, inventory oversight, and ensuring safety protocols are always followed. Known for his strong communication skills, Jake is the go-to person when issues arise on the warehouse floor. His dedication and problem-solving mindset make him an invaluable asset to the company."
                imageUrl="images/employee2.png"
            />

            <Employee
                name="Robin Williams"
                description="Robin is a meticulous warehouse accounting specialist who ensures every shipment and inventory record is accurately documented. Known for their keen eye for detail, Robin quickly identifies discrepancies and resolves them before they become major issues. Despite working behind the scenes, Robin’s efficiency keeps the entire warehouse running smoothly."
            ...
            <section id="aubottombox" className="boxaround">
                <div id="contacttext">
                    <h2>Contact Information</h2>
                        <ul id="contactinfo">
                            <li><a><img id="contactimg" src="images/email.png" alt="Email Icon"/>Email: tdunlap@cla.com</a></li>
                            <li><a> <img id="contactimg" src="images/phone.png" alt="Phone Icon"/>Phone: (843)123-4567</a></li>
                        </ul>
                </div>
            </section>
